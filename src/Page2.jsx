...
function Block({ photo, heading, name, distance, type = 1 }) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center gap-6 py-6 lg:py-5 px-4 lg:px-4 rounded-[8px] lg:text-white text-center bg-[#00000080] ">
      ...
      <div className="flex flex-col gap-6 mt-auto">
        <button
          ...
          className={
            "w-[330px] flex justify-between px-4 py-2 border-[1.5px] border-orange-500 rounded-lg bg-white text-black shadow-[#FFA50080] shadow-inner"
          }
        >
        ...
        <div className="flex justify-center">
          <button className={"w-fit font-medium px-1 py-[0.5px] border-[1px] rounded-md bg-[#F0F2F5] text-center " + textColor}>
            Search
          </button>
        </div>
      </div>
